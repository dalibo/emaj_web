<?php
	...
	$last_known_emaj_version = '4.2.0';					// Most recent known emaj version
	$last_known_emaj_version_num = 40200;
	...
	$xrefEmajPg['4.2.0']['minPostgresVersion'] = '11'; $xrefEmajPg['4.2.0']['maxPostgresVersion'] = '15';
