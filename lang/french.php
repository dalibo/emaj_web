...
//
	...
	$lang['strvaluation'] = 'Valorisation';
	...
	$lang['stremajmissing'] = 'L\'extension emaj n\'est plus installée dans la base de données, ou n\'est plus accessible par l\'utilisateur.';
...
// E-Maj groups
    ...
    $lang['strgroupsconfimport270'] = 'La table %s.%s est référencée dans %s groupes de tables différents.';
    $lang['strgroupsconfimport271'] = 'La séquence %s.%s est référencée dans %s groupes de tables différents.';
    $lang['strgroupsconfimport272'] = 'Dans le groupe de tables "%s", la table %s.%s est référencée plusieurs fois.';
    $lang['strgroupsconfimport273'] = 'Dans le groupe de tables "%s", la séquence %s.%s est référencée plusieurs fois.';
	...
	$lang['strcheckconfgroups13'] = 'Dans le groupe de tables "%s" et pour la table "%s.%s", le tablespace de l\'index de log "%s" n\'existe pas.';
	$lang['strcheckconfgroups15'] = 'Dans le groupe de tables "%s" et pour la table "%s.%s", le trigger "%s" n\'existe pas.';
	$lang['strcheckconfgroups16'] = 'Dans le groupe de tables "%s" et pour la table "%s.%s", le trigger "%s" est un trigger E-Maj.';
