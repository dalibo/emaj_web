...
//
	...
	$lang['stremajmissing'] = 'The emaj extension is not installed in the database or accessible by the user anymore.';
...
// Schemas
	...
	$lang['strcolGAES'] = 'GENERATED ALWAYS AS expression STORED';
	$lang['strcolGAE'] = 'GENERATED ALWAYS AS expression';
...
// E-Maj environment
	...
	$lang['strparhistretinfo'] = 'The \'history_retention\' parameter determines the retention delay for some internal tables containing E-Maj operations histories. The default value is 1 year. The parameter is of type INTERVAL.';
	$lang['strpardblinkcon'] = 'Dblink connection string';
	$lang['strpardblinkconinfo'] = 'The \'dblink_user_password\' parameter defines the dblink connection identifiers used by E-Maj rollbacks. The parameter content follows the usual PostgreSQL connection string format, typically \'user=<user> password=<password>\'. By default, the connection string is empty, blocking any real time E-Maj rollback monitoring and E-Maj parallel rollback launch.';
	$lang['strparalterlog'] = 'Log tables structure change';
	$lang['strparalterloginfo'] = 'The \'alter_log_table\' parameter defines the structure change to apply at log tables creation. The parameter format corresponds to an ALTER TABLE directive, for instance \'ADD COLUMN emaj_appname TEXT DEFAULT current_setting(\'\'application_name\'\')\'. The parameter is empy by default.';
	$lang['strparfixedstep'] = 'Rollback step fixed cost';
	$lang['strparfixedstepinfo'] = 'The \'fixed_step_rollback_duration\' parameter determines a fixed cost to process an elementary E-Maj rollback step. The parameter is of type INTERVAL. The default value is 2,5 ms.';
	$lang['strparfixeddblink'] = 'Dblink overhead for a rollback step';
	$lang['strparfixeddblinkinfo'] = 'The \'fixed_dblink_rollback_duration\' parameter determines the overhead generated by a dblink connection for a rollback step. The parameter is of type INTERVAL. The default value is 4 ms.';
	$lang['strparfixedrlbktbl'] = 'Table rollback fixed cost';
	$lang['strparfixedrlbktblinfo'] = 'The \'fixed_table_rollback_duration\' parameter determines a fixed cost for a table or sequence rollback. The parameter is of type INTERVAL. The default value is 1 ms.';
	$lang['strparavgrowrlbk'] = 'Average cost of an elementary update rollback';
	$lang['strparavgrowrlbkinfo'] = 'The \'avg_row_rollback_duration\' parameter determines an average cost of an elementary upde rollback. The parameter is of type INTERVAL. The default value is 100 µs.';
	$lang['strparavgrowdel'] = 'Average cost of an elementary log table deletion';
	$lang['strparavgrowdelinfo'] = 'The \'avg_row_delete_log_duration\' parameter determines an average cost of an elementary update deletion in an E-Maj log table. The parameter is of type INTERVAL. The default value is 10 µs.';
	$lang['strparavgfkcheck'] = 'Average foreign key check cost';
	$lang['strparavgfkcheckinfo'] = 'The \'avg_fkey_check_duration\' parameter determines an average cost to ckeck a foreign key. The parameter is of type INTERVAL. The default value is 20 µs.';

	// Import parameters
	$lang['strimportparamconf'] = 'Import a parameters configuration';
	$lang['strresetotherparams'] = 'Reset other parameters';
	$lang['strresetotherparamsinfo'] = 'If the box is checked, parameters not described in the imported JSON structure are reset to their default value.';
	...
	$lang['strcheckjsonparamconf106'] = 'For key "%s", the value ("%s") is not a valid time interval.';
