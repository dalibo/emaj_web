<?php
	...
	$last_known_emaj_version = '5.0.0';					// Most recent known emaj version
	$last_known_emaj_version_num = 50000;
	...
	$xrefEmajPg['5.0.0']['minPostgresVersion'] = '14'; $xrefEmajPg['5.0.0']['maxPostgresVersion'] = '19';
