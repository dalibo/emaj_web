<?php
	...
	function gen_sql_dump_changes() {
		...
		$emajCols = $emajdb->getEmajColumns($_REQUEST['group'], $_REQUEST['schema'], $_REQUEST['table'], $_REQUEST['startMark']);
	...
	function gen_sql_dump_changes_ok() {
		...
		$sql_text = $emajdb->genSqlDumpChanges($_POST['group'], $_POST['schema'], $_POST['table'], $_POST['startMark'], $_POST['endMark'],
